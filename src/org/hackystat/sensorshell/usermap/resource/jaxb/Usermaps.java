...
@XmlRootElement(name = "usermaps")
public class Usermaps {

    @XmlElement(required = true)
    protected List<Usermap> usermap;
     ...
     * This is why there is not a <CODE>set</CODE> method for the usermap property.
     * 
     * <p>
